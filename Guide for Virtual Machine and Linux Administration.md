...
## 2. Characteristics of Rocky and Debian & Basic Differences
...
## 3. Why are Virtual Machines Used?
Virtual machines are used for several reasons:

Isolation: VMs run separately from the host OS, so they don’t interfere with the host's software.
